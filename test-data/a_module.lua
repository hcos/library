...
assert.has.no.error (function ()
  ...
  require "https://raw.githubusercontent.com/CosyVerif/lang/master/src/cosy/util/http_require_data.test.lua"
end)

-- The extended `require` loads effectively the required module.
local remote_module = require "https://raw.githubusercontent.com/CosyVerif/lang/master/src/cosy/util/http_require_data.test.lua"
local local_module = require "cosy.util.http_require_data.test"
